...
Pull requests are the best way to propose changes to the codebase, so all code changes happen through pull requests.
...
`$ git add [file.name]`
 ...
 You can review pull requests at https://github.com/GSA/sagemaker-pilot/pulls. If you like the code, you can merge it into master by pressing the big green Merge button. And then you're done!
...
## Report bugs using Github's [issues](https://github.com/GSA/sagemaker-pilot/issues)

We use GitHub issues to track public bugs. Report a bug or request a feature by opening a new issue.
